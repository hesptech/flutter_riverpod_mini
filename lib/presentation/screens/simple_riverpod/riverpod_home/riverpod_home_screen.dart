...
class RiverpodHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simple Riverpod Providers'),
      ),
      body: const _RiverpodHomeScreenView(),
    );
  }
}

class _RiverpodHomeScreenView extends StatelessWidget {
  const _RiverpodHomeScreenView();
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: const [
        ...
        _CustomListTile(
            title: 'Simple Riverpod Provider',
            subTitle: 'Un provider de sólo lectura',
            location: '/simple-riverpod-provider'),
